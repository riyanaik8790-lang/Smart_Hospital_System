...
const sampleStats = {
  Today: { totalPatients: 48, admittedPatients: 19, criticalPatients: 4, availableDoctors: 35, availableRooms: 50, emergencyAvailable: 4 },
  'This Week': { totalPatients: 286, admittedPatients: 74, criticalPatients: 12, availableDoctors: 31, availableRooms: 38, emergencyAvailable: 2 },
  'This Month': { totalPatients: 1142, admittedPatients: 218, criticalPatients: 27, availableDoctors: 28, availableRooms: 24, emergencyAvailable: 1 },
};
